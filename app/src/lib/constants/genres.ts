...
export const GENRES: GenreMeta[] = [
  { slug: "bar-restaurant",     name: "バー・飲食店",              sortOrder: 1 },
  { slug: "hattenba",           name: "ハッテンバ",                sortOrder: 2 },
  { slug: "massage-urisen",     name: "マッサージ・売り専",        sortOrder: 3, hasServiceAreas: true },
  ...
  { slug: "fashion-beauty",     name: "ファッション・美容",        sortOrder: 9 },
